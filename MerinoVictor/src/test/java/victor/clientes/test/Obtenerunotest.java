...
public class Obtenerunotest {
	...
	@Test
	public void cuandoFindByIdentoncesTieneTodosSusDatosvito() {
		ClienteVO vito = this.dao.findById("1111111-1").get();
		ClienteVO vitoOriginal = new ClienteVO("1111111-1","vito","merino" , "vito@blabla", "13245678");
		boolean sonIguales = vito.equals(vitoOriginal);
